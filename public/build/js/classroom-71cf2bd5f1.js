...
function block_change(){
    $(".block").on('click',function(){
        ...
        save_state( $("[name='lesson-content']").data('enrollment'));
            ...
            player.addEvent('ready', function () {
                ...
                if ($("#actual-content").data('actual-content') == 12323) {
                    ...
                    with_view(function() {
                        ...
                        like();
                        rate(enrollment_id);
                        if(view_progress_interval != 0) window.clearInterval(view_progress_interval);
...
function create_dashboard_right_chart(){
    ...
    console.log("nesse exato momento entra");
