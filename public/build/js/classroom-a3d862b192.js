    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.trim() === '1'){
                ...
                $("#asktheteacher_return").html('Mensagem enviada com sucesso! Acompanhe na seção Fale Conosco');
            } else {
