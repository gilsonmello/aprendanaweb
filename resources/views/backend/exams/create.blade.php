...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.exams.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'files' => true]) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {!! Form::text('max_tries',  $configuration->video_views, ['class' => 'form-control', 'placeholder' => trans('strings.max_tries')]) !!}
        </div>
    </div><!--form control-->
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {!! Form::text('duration', null, ['class' => 'form-control', 'placeholder' => trans('strings.time_to_execute')]) !!}
        </div>
    </div><!--form control-->
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {!! Form::text('video_time', null, ['class' => 'form-control', 'placeholder' => trans('strings.total_video_time')]) !!}
        </div>
    </div><!--form control-->
