        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <iframe id="vimeo-preview" src="{{$workshopactivity->explanation_url}}" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" width="100%" height="400" frameborder="0">
                            </iframe>
