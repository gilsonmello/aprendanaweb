...
@section('content')
    ...
    <div class="pull-right" style="margin-bottom:10px">
        <a href="{{route('admin.questions.create')}}" class="btn btn-primary btn-xs">
    ...
    <div class="box box-primary">
        ...
        {!! Form::open(array('route' => array('admin.questions.index'), 'class' => 'form-horizontal', 'method' => 'get'))  !!}
        <div class="box-body">
            <div class="row">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <th width="10%">{{ trans('crud.actions') }}</th>
        </tr>
        </thead>
        <tbody>
