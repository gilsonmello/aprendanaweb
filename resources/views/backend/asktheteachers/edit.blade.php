...
@section ('breadcrumbs')
    ...
    <li>{!! link_to_route('admin.asktheteachers.index', trans('menus.asktheteachers')) !!}</li>
    <li class="active">{!! link_to_route('admin.asktheteachers.create', trans('menus.edit_asktheteacher')) !!}</li>
@stop

@section('content')

    {!! Form::model($asktheteacher, ['route' => ['admin.asktheteachers.update', $asktheteacher->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'files' => true]) !!}
    ...
    <div class="form-group">
        {!! Form::label('teacher', trans('strings.teacher'), ['class' => 'col-lg-2 control-label']) !!}
        <div class="col-lg-10">
