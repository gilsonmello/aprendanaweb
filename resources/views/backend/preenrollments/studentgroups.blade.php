...
@section('content')
    ...
    <div class="pull-right" style="margin-bottom:10px">
        <a href="{{route('admin.preenrollments.index')}}" class="btn btn-primary btn-xs">
            {{ trans('strings.back') }}
        </a>
    </div>
    ...
    <div class="box box-primary">
        ...
        {!! Form::open(array('route' => array('admin.preenrollments.studentgroups'), 'class' => 'form-horizontal', 'method' => 'get'))  !!}
        <div class="box-body">
            <div class="row">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        @foreach ($studentgroups as $studentgroup)
            <tr>
                ...
                <td>{!! $studentgroup->email_button !!}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
