...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('menus.edit_faq_category') }}</small>
    </h1>
@endsection
...
@section ('breadcrumbs')
    ...
    <li class="active">{!! link_to_route('admin.faqcategory.create', trans('menus.edit_faq_category')) !!}</li>
@stop

@section('content')

    {!! Form::model($faqcategory, ['route' => ['admin.faqcategory.update', $faqcategory->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}
