...
@section('content')
    ...
    {!! Form::open(['route' => 'admin.userteachers.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'files' => true, 'onsubmit' => 'javascript:.zip.blur();']) !!}
    ...
    <div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-lg-10">
            {!! Form::text('cel', null, ['class' => 'cel form-control cel', 'placeholder' => trans('strings.cel')]) !!}
        </div>
    </div><!--form control-->
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {!! Form::text('birthdate', null, ['class' => 'form-control birthdate date', 'placeholder' => trans('strings.birthdate')]) !!}
        </div>
    </div><!--form control-->
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {!! Form::text('zip', null, ['class' => 'form-control zip', 'placeholder' => trans('strings.zip') ]) !!}
        </div>
    </div><!--form control-->
        ...
        <div class="col-lg-1">
            <div class="sw-green create-permissions-switch">
                <div class="onoffswitch">
                    <input type="checkbox" value="1" name="has_children" class="toggleBtn onoffswitch-checkbox" id="has_children-active" >
    ...
    <div class="form-group">
        ...
        <div class="col-lg-1">
            <div class="sw-green create-permissions-switch">
                <div class="onoffswitch">
                    <input type="checkbox" value="1" name="is_newsletter_subscriber" class="toggleBtn onoffswitch-checkbox" id="is_newsletter_subscriber-active" >
    ...
    <div class="form-group">
        ...
        <div class="col-lg-1">
            <div class="sw-green create-permissions-switch">
                <div class="onoffswitch">
                    <input type="checkbox" value="1" name="list_on_site" class="toggleBtn onoffswitch-checkbox" id="user-list_on_site" >
                    <label for="user-list_on_site" class="onoffswitch-label">
                        <div class="onoffswitch-inner"></div>
                        <div class="onoffswitch-switch"></div>
                    </label>
                </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-1">
            <div class="sw-green create-permissions-switch">
                <div class="onoffswitch">
                    <input type="checkbox" value="1" name="featured" class="toggleBtn onoffswitch-checkbox" id="user-featured" >
                    <label for="user-featured" class="onoffswitch-label">
                        <div class="onoffswitch-inner"></div>
                        <div class="onoffswitch-switch"></div>
                    </label>
                </div>
