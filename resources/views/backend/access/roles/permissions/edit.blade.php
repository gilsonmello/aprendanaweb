            ...
            <div class="col-lg-3">
                @if (count($roles) > 0)
                    ...
                    <div class="create-permissions-switch">
                        <div class="onoffswitch">
                            <input type="checkbox" {{$role->id == 1 && Config::get('access.roles.Administrador_forced') ? "disabled='disabled'" : ''}} {{in_array($role->id, $permission_roles) || ($role->id == 1 && Config::get('access.roles.Administrador_forced')) ? 'checked="checked"' : ""}} value="{{$role->id}}" name="permission_roles[]" class="toggleBtn onoffswitch-checkbox" id="role-{{$role->id}}">
                ...
                @if (Config::get('access.roles.Administrador_forced'))
