...
@section('content')
    ...
    {!! Form::model($workshop_tutor, ['route' => ['admin.workshoptutors.update', $workshop_tutor->id], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}

    <div class="form-group">
        {!! Form::label('name', trans('strings.name'), ['class' => 'col-lg-2 control-label']) !!}
        <div class="col-lg-10">
            {!!  $workshop_tutor->tutor->name !!}
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {!!  $workshop_tutor->criteria->description !!}
        </div>
        ...
        <div class="col-lg-1">
            <div class="sw-green create-permissions-switch">
                <div class="onoffswitch">
                    <input type="checkbox" value="1" name="is_active" class="toggleBtn onoffswitch-checkbox" id="course-active" @if($workshop_tutor->is_active == 1)checked="checked"@endif>
