...
@section('meta-description', $package->title)
                        ...
                        <div class="list-group">
                            <ul>
                                ...
                                @if($package->exams->count() === 1)
                                    ...
                                    <li class="list-group-item col-sm-4">
                                        <i class="fa fa-clock-o"></i>
                                        Modo Comentado<br> <b>{{ parse_duration_to_time_string($package->exams[0]->exam->duration) }} {{($package->exams[0]->exam->video_time != null) && ($package->exams[0]->exam->video_time != 0) ? " + " .  $package->exams[0]->exam->questions_count . ' vídeos/áudio' : "" }} </b>
                                    </li>
                                    <li class="list-group-item col-sm-4">
                                        <i class="fa fa-play"></i>
                                        {!! $package->exams[0]->exam->questions_count !!} vídeos/áudio<br> <b>{{ parse_duration_to_time_string($package->exams[0]->exam->video_time) }}</b>
                                    </li>
                                @else
                                <li class="list-group-item col-sm-4">
