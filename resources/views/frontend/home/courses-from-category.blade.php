...
<div class="section no-margin-bottom">
    <div class="container">
         <div class="page-breadcrumbs" style="margin-top:0px; margin-bottom: 0px">
            {{-- <a href="{{ $coursesCategory->first()->subsection->section->slug }}"> --}}
                <h1 class="section-title">{{  $coursesCategory->first()->subsection->section->name}}</h1>
            {{-- </a> --}}
            {{-- <div class="world-nav cat-menu">
                <ul class="list-inline">
                    <li><a href="{{ $coursesCategory->first()->subsection->section->slug }}"><strong>Todos os cursos</strong></a></li>
                </ul>
            </div>  --}}
        </div> 
        ...
        <div class="row"><div class="space small"></div>
           {{--  <div class="col-md-6 col-sm-6">
            ...
            <!-- Coluna da esquerda, impressão de 2 cursos-->
            <div class="col-md-6 col-sm-6">
                <div class="section curso-small">
                    @foreach($coursesCategory as $key => $course)
                        @if($key == 0 || $key == 1)
                            <div class="card">
                                <div class="post small-post">
                                    <div class="entry-header">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h3 class="entry-title-big">
                                            <a href="{{route('course-section-ga', [$course->subsection->section->slug,$course->slug])  }}">{{ str_limit($course->title, 80) }}</a>
                                        </h3>
                                        <div class="entry-content">
            ...
            <!-- Coluna da direita, impressão de 2 cursos-->
            <div class="col-md-6 col-sm-6">
                <div class="section curso-small">
                    @foreach($coursesCategory as $key => $course)
                        @if($key == 2 || $key == 3)
