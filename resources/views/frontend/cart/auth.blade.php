                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="ragister-account">
                                    ...
                                    {!! Form::open([ 'id'=> "registation-form", 'name'=> "registation-form",'url' => 'auth/register', 'class' => 'form-horizontal register_on_cart', 'role' => 'form', 'method' => 'post']) !!}
                                    {!! Form::hidden('from_cart', 1) !!}
                                    <div class="clearfix"></div>
                                    <div class="form-group col-xs-12 col-sm-12 col-md-12">
                                        {!! Form::label('name', trans('validation.attributes.namesurname')) !!}
                                        {!! Form::input('text', 'name', null, ['class' => 'form-control', 'id' => 'name','placeholder' => "Digite o nome"]) !!}
                                    </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-12">
                                        {!! Form::label('email', trans('validation.attributes.email')) !!}
                                        {!! Form::input('email', 'email', old('email'), ['id' => 'email_register', 'class' => 'form-control', 'placeholder' => 'Digite o seu login']) !!}
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6 pull-left ragister-account-margin">
                                        {!! Form::label('password', trans('validation.attributes.password')) !!}<span style="font-size: 12px">&nbsp;&nbsp;( Mínimo de 6 dígitos )</span>
                                        {!! Form::input('password', 'password', null, ['class' => 'form-control']) !!}
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6 pull-left ragister-account-margin">
                                        ...
                                        <div class="radio-inline">
                                            <label>
                                                ...
                                                {!! trans('strings.male') !!}
                                                <p class="p-error" style="display:none;" style="color: red;">Campo Obrigatório</p>
                                            </label>
                                        </div>
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6 col-md-6  pull-left ragister-account-margin">
                                        ...
                                        {!! Form::text('city', null, ['class' => 'form-control', 'data-not-required' => 'true' , 'disabled' => 'disabled', 'placeholder' => trans('strings.city')]) !!}
                                    </div><!--form control-->

                                    <div class="form-group col-xs-12  col-sm-6 col-md-6 pull-left ragister-account-margin">
                                        {!! Form::label('state', trans('strings.state')) !!}
                                        {!! Form::text('state', null, ['data-not-required' => 'true', 'class' => 'form-control', 'disabled' => 'disabled', 'placeholder' => trans('strings.state')]) !!}
                                    </div><!--form control-->
                                    <div class="clearfix"></div>
                                    ...
                                    <div class="form-group checkbox col-md-12">
                                        <label>
                                            <input data-not-required="true" type="checkbox" value="">
                                            Desejo receber a Brasil Jurídico Newsletter
                                        </label>
                                    ...
                                    <div class="form-group checkbox col-md-12">
                                        ...
                                        <label>
                                            <input type="checkbox" class="signing" value="1" name="signing" id="signing">
