    ...
    <div class="navbar" role="banner">
                    ...
                    <div class="hidden-xs hidden-sm">
                        <div id="topbar-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="https://www.facebook.com/BrasilJuridicoCursos" target="_blank" style="color: #1E376D;"><i class="fa fa-facebook"></i> Facebook</a></li>
                                <li><a href="https://www.instagram.com/brasiljuridico/" target="_blank" style="color: #1E376D;"><i class="fa fa-instagram"></i> Instagram</a></li>
                                <li><a href="https://www.youtube.com/channel/UC3FD5PHIbVPvVjYDAfpq_Mw" target="_blank" style="color: #1E376D;"><i class="fa fa-youtube-play"></i> YouTube</a></li>
                            </ul>
        ...
        <div id="menubar" class="container">    
            <nav id="mainmenu" class="navbar-left collapse navbar-collapse"> 
                <ul class="nav navbar-nav">
                    <li class="politics dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" style="color: #1E376D;">O BRJ</a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('brasil-juridico') }}" style="color: #1E376D;">INSTITUCIONAL</a></li>
                            <li><a href="{{ route('teachers') }}" style="color: #1E376D;">PROFESSORES ASSOCIADOS</a></li>
                            <li><a href="{{ route('termos-de-uso') }}" style="color: #1E376D;">TERMOS DE USO</a></li>
                            <li><a href="{{ route('contactus.index') }}" style="color: #1E376D;">FALE CONOSCO</a></li>
                            {{--<li><a href="{{ route('faqs') }}">FAQ</a></li>--}}
                </ul>
                </li>
                <li class="politics dropdown"><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" style="color: #1E376D;">MÉTODO BRJ</a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('frontend.methodology-oab') }}" style="color: #1E376D;">PARA OAB</a></li>
                        {{-- <li><a href="{{ route('frontend.methodology-concursos') }}" style="color: #1E376D;">PARA CONCURSOS</a></li> --}}
                </ul>
                </li>
                ...
                <li class="menu-item dropdown" ><a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown"  style="color: #1E376D;">+INFORMAÇÃO</a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('tv-videos') }}"  style="color: #1E376D;">TEMAS EM DESTAQUE</a></li>
                ...
                <li class="menu-item">
                    <a href="{{url('/gestaopublica')}}" style="color: #1E376D;">GESTÃO PÚBLICA</a>
                </li>
