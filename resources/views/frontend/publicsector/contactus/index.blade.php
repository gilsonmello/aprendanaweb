...
<section id="main-content">
    <div class="container">
        <section id="search-meaning">
            ...
            <p class="meaning-text">Entre em contato com o BrJ Gestão Pública</p>
        </section>
        ...
        <div class="row">
            <div class="col-md-9 no-padding">
                ...
                {!! Form::open(['route' => ['publicsector.contactus.send'], 'class' => 'form-horizontal', 'style' => 'margin-top:30px;padding:20px;', 'role' => 'form', 'method' => 'POST']) !!}
                ...
                <div class="form-group">
                    {!! Form::label('phone', trans('Telefone'), ['class' => 'col-md-2 control-label']) !!}
                    <div class="col-md-10">
