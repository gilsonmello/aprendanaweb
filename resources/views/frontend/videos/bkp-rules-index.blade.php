<div class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                {{ trans('strings.test') . ' 1: ' . trans('strings.you_can_see_because', ['role' => trans('roles.Administrador')]) }}
            </div>
        </div><!-- panel -->
    ...
    @if (access()->hasRole('Administrador'))
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ trans('strings.test') . ' 2: ' . trans('strings.you_can_see_because', ['role' => trans('roles.Administrador')]) }}
                </div>
            </div><!-- panel -->
    ...
    @if (access()->hasRole(1))
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ trans('strings.test') . ' 3: ' . trans('strings.you_can_see_because', ['role' => trans('roles.Administrador')]) }}
                </div>
            </div><!-- panel -->
    ...
    @if (access()->hasRoles(['Administrador', 1]))
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ trans('strings.test') . ' 4: ' . trans('strings.you_can_see_because', ['role' => trans('roles.Administrador')]) }}
                </div>
            </div><!-- panel -->
    ...
    {{-- The second parameter says the user must have all the roles specified. Administrador does not have the role with an id of 2, so this will not show. --}}
    @if (access()->hasRoles(['Administrador', 2], true))
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {{ trans('strings.you_can_see_because', ['role' => trans('roles.Administrador')]) }}
                </div>
            </div><!-- panel -->
