                    ...
                    <div class="row" style="background-image: url('../../../../img/landingpages/etica_e_oab/fundo_cinza_grande.png')">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 video">
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/ADq9JH02By8" frameborder="0" allowfullscreen></iframe>
                            </div>
                                ...
                                <fieldset>
                                    <form action="" method="POST" id="subscribe_oab_e_etica">
                                        <div class="form-group col-xs-12 col-sm-12 col-md-12" style="margin-bottom: 2px;">
                                            <div id="alert" style="color: white; background-color: #00a65a !important; border-radius: 3px; padding: 15px; border: 1px solid transparent" class="form-group col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-md-12">
                                <p style="width: 75%; color: #00539d; text-align: center; margin: 0 auto;">
                                    No dia <strong>13 de Março</strong>, o professor Jonnas Vasconcelos vai liberar uma aula especial com dicas indispensáveis para você garantir pontuação máxima em <strong>Ética</strong> no <strong>XXII Exame da OAB</strong>.
                                    Além disso, irá disponibilizar um <strong>e-book inédito</strong> com trechos do seu novo livro com <strong>tabelas esquematizadas</strong> da disciplina.
                                </p>
                                <br>
                            </div>
                        </div>
