...
/**
 * Class LessonAttributes
 * @package App\Services\Lesson\Traits
 */
trait LessonAttributes {
    ...
    public function getEditButtonAttribute() {
        return '<a href="' . route('admin.lessons.edit', $this->id) . '" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
    }
    ...
    public function getDeleteButtonAttribute() {
        return '<a href="' . route('admin.lessons.destroy', $this->id) . '" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
