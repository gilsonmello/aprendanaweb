<?php namespace App\Services\Banner\Traits;
use Carbon\Carbon;
...
trait BannerAttributes {
    ...
    public function getEditButtonAttribute() {
        if($this->status != 1)
            return '<a href="'.route('admin.banners.edit', $this->id).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
    }
    ...
    public function getDeleteButtonAttribute() {
        if($this->status != 1)
            return '<a href="'.route('admin.banners.destroy', $this->id).'" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
