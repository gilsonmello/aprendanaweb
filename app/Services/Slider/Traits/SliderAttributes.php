<?php namespace App\Services\Slider\Traits;
use Carbon\Carbon;
...
trait SliderAttributes {
    ...
    public function getEditButtonAttribute() {
        if($this->status != 1)
            return '<a href="'.route('admin.sliders.edit', $this->id).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
    }
    ...
    public function getDeleteButtonAttribute() {
        if($this->status != 1)
            return '<a href="'.route('admin.sliders.destroy', $this->id).'" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
