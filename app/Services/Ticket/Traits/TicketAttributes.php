<?php namespace App\Services\Ticket\Traits;
use Carbon\Carbon;
...
trait TicketAttributes {
    ...
    public function getDeleteButtonAttribute() {
        if($this->status != 1)
            return '<a href="'.route('admin.tickets.destroy', $this->id).'" data-method="delete" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="' . trans('crud.delete_button') . '"></i></a>';
    }
     ...
     * @return string
     */
    public function getStudentButtonAttribute() {
        if($this->status != 1)
            return '<a href="'.route('student.ticketstudents.edit', $this->id).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
    }
