 ...
 */
trait UserRepresentativesAttributes {

	/**
	 * @return string
	 */
	public function getRepresentativeEditButtonAttribute() {
		return '<a href="'.route('admin.userrepresentatives.edit', $this->id).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="' . trans('crud.edit_button') . '"></i></a>';
	}

	/**
	 * @return string
	 */
	public function getRepresentativeChangePasswordButtonAttribute() {
	 ...
	 * @return string
	 */
	public function getRepresentativeStatusButtonAttribute() {
		switch($this->status) {
			case 0:
	...
	public function getRepresentativeConfirmedButtonAttribute() {
		if (! $this->confirmed)
	 ...
	 * @return string
	 */
	public function getRepresentativeDeleteButtonAttribute() {
	 ...
	 * @return string
	 */
	public function getRepresentativeActionButtonsAttribute() {
		return $this->getRepresentativeEditButtonAttribute().' '.
		$this->getRepresentativeChangePasswordButtonAttribute().' '.
		$this->getRepresentativeStatusButtonAttribute().
		$this->getRepresentativeConfirmedButtonAttribute().
		$this->getRepresentativeDeleteButtonAttribute();
	}
}