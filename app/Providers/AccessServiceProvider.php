...
class AccessServiceProvider extends ServiceProvider
{
	...
	public function registerBindings() {
		...
		$this->app->bind(
			'App\Repositories\Frontend\User\UserStudentContract',
			'App\Repositories\Frontend\User\EloquentUserStudentRepository'
		);
		...
		$this->app->bind(
			'App\Repositories\Backend\Auth\AuthenticationContract',
			'App\Repositories\Backend\Auth\EloquentAuthenticationRepository'
		);
	}
