...
Route::group([
    ...
    'role'       => ['Administrador', 'Relacionamento'],
    'redirect'   => '/',
...
], function ()
{
    ...
    post('users/select', ['as' => 'admin.users.select', 'uses' => 'UserController@selectUser']);
...
get('importphotos',  ['as' => 'admin.access.user.importphotos', 'uses' => 'Access\UserController@importPhotos']);